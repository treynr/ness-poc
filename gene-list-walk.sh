...
filters="--save-genes"
input="--input-file $data_dir/genes-pm-kegg-hsa-filtered.tsv"
## Stack executable
stack="$HOME/.local/bin/stack"
## Output filepath
output="$data_dir/kegg-pathway-gene-walk.tsv"
...
if [[ "x" == "x$NUM" ]]; then
	...
	input="--input-file $data_dir/genes-pm-kegg-hsa-filtered-${NUM}.tsv"
	output="$data_dir/kegg-pathway-gene-walk-${NUM}.tsv"
fi
